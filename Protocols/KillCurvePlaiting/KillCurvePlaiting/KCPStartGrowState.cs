...
{
	/// <summary>
	/// Description of KCPStartGrow.
	/// </summary>
	[State("Start ON Grow","Start of  ON grow")]
	public class KCPStartGrowState:RunRobotState,IRestartableState
	{
		int LicONInd;
		

		
		public KCPStartGrowState(int LicONInd):base()
		{
		...
		protected override RobotJob BeforeRobotRun()
		{
			...
			RobotJob RJ = new RobotJob(
				@"D:\OctoTip\Protocols\KillCurvePlaiting\Scripts\StartGrow.esc",RJP);
		...
		{
			return new List<Type>{typeof(KCPGrowState)};
		}
		#endregion
	}
