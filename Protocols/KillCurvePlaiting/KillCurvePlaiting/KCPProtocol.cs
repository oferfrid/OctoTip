	...
	public class KCPProtocol:Protocol
	{
		...
		protected override void DoWork( )
		{
			...
			if(ProtocolParameters.RunStart)
			{
				...
				this.ChangeState(new KCPStartKillState(ProtocolParameters.Sample6IndInLiconic,ProtocolParameters.NumberOfSamples,ProtocolParameters.ONStartwellIndex,ProtocolParameters.AMPPosision));
			}
