...
namespace SerialDilutionEvolution
{
	...
	public class SDEDilute2NewPlateState:RunRobotState,IRestartableState
	{
		int LicFromPlateInd;
		int LicToPlateInd;
		int FreezeInd;
		int Dilution348Ind;
		public SDEDilute2NewPlateState(int LicFromPlateInd,int LicToPlateInd,int FreezeInd,int Dilution348Ind ):base()
		{
...
//ImportVariable(Lic24PlateCart#Lic24PlatePos#Lic24NewPlateCart#Lic24NewPlatePos#Dilution348Ind#FreezeInd,"D:\OctoTip\Protocols\SerialDilutionEvolution\Scripts\Dilute2NewPlateData.csv",0#0#0#0#0#0,"1#1#2#2#1#0",0,1,0,1,1);			
			...
			RobotJob RJ = new RobotJob(
				@"D:\OctoTip\Protocols\SerialDilutionEvolution\Scripts\Dilute2NewPlate.esc",RJP,0.9);
