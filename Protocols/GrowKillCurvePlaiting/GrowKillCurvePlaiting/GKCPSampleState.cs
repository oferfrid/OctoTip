...
{
	/// <summary>
	/// Description of GKCPSumpleState.
	/// </summary>
	[State("Sample","Sample bacteria to ")]
	public class GKCPSampleState:RunRobotState,IRestartableState
	{
		...
		public GKCPSampleState(int LicInd, int NumberOfSamples,int FirstSampleEppendorfInd ):base()
		{
			this.LicInd = LicInd;
...
//ImportVariable(Liconic24PlateCart#Liconic24PlatePos#NumberOfSamples#FirstSampleEppendorfInd,"D:\OctoTip\Protocols\GrowKillCurvePlaiting\Scripts\TakeSampleData.csv",0#0#0#0,"1#1#2#1",0,1,0,1,1);
			...
			RobotJob RJ = new RobotJob(
				@"D:\OctoTip\Protocols\GrowKillCurvePlaiting\Scripts\TakeSample.esc",RJP);
		...
		{
			return new List<Type>{typeof(GKCPWaitState)};
		}
		#endregion
	}
}
